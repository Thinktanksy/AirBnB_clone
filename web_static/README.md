...
create a simple flow of serialization/deserialization: Instance <-> Dictionary <-> JSON string <-> file<create all classes used for AirBnB (User, State, City, Place…) that inherit from BaseModel
