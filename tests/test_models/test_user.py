#!/usr/bin/env python3
#!/usr/bin/python3
"""States the unittests for models/user.py.
Unittest classes:
...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_last_name_attr(self):
        """Test that it's an empty string and User has attr last_name"""
        user = User()
        self.assertTrue(hasattr(user, "last_name"))
        self.assertEqual(user.last_name, "")

    def test_str(self):
        """Verify that the str method yields the output using test case"""
        user = User()
    ...
    def test_to_dict_values(self):
        """test that values in dict returned from to_dict correct"""
